...
namespace HearthstoneCards.Caroussel
{
    public class LightStone : Canvas
    {
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(IList), typeof(LightStone), new PropertyMetadata(0, OnItemsSourceChanged));
        ...
        public static readonly DependencyProperty MaxVisibleItemsProperty =
            DependencyProperty.Register("MaxVisibleItems", typeof(int), typeof(LightStone), new PropertyMetadata(5, OnLightStonePropertyChanged));
        ...
        public static readonly DependencyProperty DepthProperty =
            DependencyProperty.Register("Depth", typeof(double), typeof(LightStone), new PropertyMetadata(0.0, OnLightStonePropertyChanged));
        ...
        private static void OnItemsSourceChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs args)
        {
            ...
            var caroussel = dependencyObject as LightStone;
            if (caroussel == null)
                return;
