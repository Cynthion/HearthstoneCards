...
{
    /// <summary>
    /// Implementation of the <see cref="ICollectionViewEx"/> interface,
    /// which extends the standard WinRT definition of the see <see cref="ICollectionView"/>
    /// interface to add sorting and filtering.
    /// </summary>
    public class CollectionViewEx : BaseNotifyPropertyChanged, ICollectionViewEx, IComparer<object>
    {
        ...
        public CollectionViewEx(object source)
        {
        ...
        public CollectionViewEx() : this(null) { }
        ...
        {
            CollectionViewEx _view;
            object _currentItem;

            internal DeferNotifications(CollectionViewEx view)
            {
                _view = view;
